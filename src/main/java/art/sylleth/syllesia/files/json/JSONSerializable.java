 ...
 *
 * @author Jay Gimbird
 * <a href="https://github.com/Ankoki/Roku/blob/master/src/main/java/com/ankoki/roku/web/json/JSONSerializable.java">Taken from a previous project.</a>
 */
public abstract class JSONSerializable {

    private static final Map<String, Class<? extends JSONSerializable>> registry = new ConcurrentHashMap<>();
